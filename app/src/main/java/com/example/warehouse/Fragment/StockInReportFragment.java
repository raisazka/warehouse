...
public class StockInReportFragment extends Fragment {
    View v;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_stock_in_report, container, false);
        generateBtn = v.findViewById(R.id.btn_generate_stockin);
        ...
        generateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkPermission()){
                    call = service.getReport("get-stock-in/"+ prefs.getInt("wh-id", 0));
                                ...
                                new AsyncTask<Void, Void, Void>() {
                                    ...
                                    protected Void doInBackground(Void... voids) {
                                        try{
                                            ...
                                            File file = new File(path+File.separator+"stock-in"+File.separator,filename);
